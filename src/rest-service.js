...
class RestService {
  ...
  start() {
    ...
    this.router.get('/v1/user/:userId/order-list', makeHttpCallabck({controller: contollers.getOrdersAction}));
    ...
    this.router.get('/v1/user/:userId/subscription', makeHttpCallabck({controller: contollers.getSubscriptionAction}));
    this.router.post('/v1/user/:userId/subscription', makeHttpCallabck({controller: contollers.addSubscriptionAction}));
  }
